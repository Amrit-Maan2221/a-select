(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.ASelect = factory(global.$, global.Popper));
    ...
    const originalVal = $__default["default"].fn.val;
    $__default["default"].fn.val = function (value) {
        if (value === undefined) {
            return originalVal.call(this);
        }
        return this.each(function () {
            const instance = $__default["default"](this).data("aselect");
            if (instance) {
                instance.selectRow(value, false);
            } else {
                originalVal.call($__default["default"](this), value);
            }
        });
    };
    ...
    function getScrollableParents($ctx) {
        return $ctx.parents().filter(function () {
            return (
                $__default["default"](this).css("overflow") === "auto" ||
                $__default["default"](this).css("overflow-y") === "scroll" ||
                $__default["default"](this).css("overflow-x") === "scroll"
            );
        });
    }
    ...
    $__default["default"].fn.aSelect = function (options) {
        if (typeof options === 'string') {
            const method = options;
            return this.each(function () {
                const instance = $__default["default"](this).data(dataAttrs.instance);
        ...
        const defaultOptions = $__default["default"].fn.aSelect.defaults || {};
        const settings = $__default["default"].extend(
            {
                onOpen: null,
                uniqueBy: [],
                onClose: null,
        ...
        return this.each(function () {
            const $select = $__default["default"](this);
            if (!$select.data(dataAttrs.instance)) {
                if ($select.attr(dataAttrs.quickLinks)) {
                    settings.quickLinks = $__default["default"]($select.attr(dataAttrs.quickLinks)).prop("outerHTML");
                }
    ...
    /** ------------------------
        ...
        class ASelect {
            ...
            buildBaseStructure() {
                this.$wrapper = $__default["default"](`<div class="a-select-wrapper" data-aselect-id="${this.options.id}""></div>`);
                this.$wrapper.data('select', this.$select);
                this.$display = $__default["default"](`<div class="a-select-display" tabindex="0"></div>`).text(this.options.placeHolder);
                if (!this.isMultiple) {
                ...
                if (this.options.showClearButton) {
                    this.$clearButton = $__default["default"](
            ...
            initializeClientSide() {
                ...
                this.$select.find("option").each(function () {
                    const $opt = $__default["default"](this);
                    if (!$opt.val()) return;

                    const $row = $__default["default"]('<tr role="option"></tr>').attr("data-select-id", $opt.val());
            ...
            bindDependentFields() {
                ...
                this.options.dependsOn.forEach((dep) => {
                    const $depField = $__default["default"](dep.selector);
                    if ($depField.length) {
            ...
            appendPlaceholderOption() {
                const $opt = $__default["default"]('<option>').val('')
            ...
            setupMouseEvents() {
                ...
                this.$tableBody.on("mouseenter.aSelect", "tr:not(.aselect-ignore)", function () {
                    ...
                    $__default["default"](this).addClass("table-warning");
                });

                this.$tableBody.on("mouseleave.aSelect", "tr:not(.aselect-ignore)", function () {
                    $__default["default"](this).removeClass("table-warning");
                });
            }
            ...
            setupTableRowClickEvent() {
                ...
                this.$tableBody.on("click.aSelect", "tr:not(.aselect-ignore)", function () {
                    const $row = $__default["default"](this);
            ...
            setupSearchEvent() {
                ...
                this.$search.on("input.aSelect", function () {
                    const rawVal = $__default["default"](this).val().trim();
            ...
            showCreatableOption(searchText) {
                ...
                const $creatableRow = $__default["default"](`
            ...
            handleCreatableEntry(value) {
                ...
                const $newOption = $__default["default"]('<option>')
                    .val(newValue)
                    .text(value)
                    .attr('data-new', 'true');
            ...
            initializePopper() {
                this.popperInstance = Popper__default["default"].createPopper(
                    this.$display[0],
                    this.$dropdown[0],
                    {
            ...
            closeDropdown() {
                ...
                if (this.$scrollableParents) {
                    this.$scrollableParents.each(function () {
                        $__default["default"](this).off("scroll.aSelect");
                    });
                }
                $__default["default"](document).off("mousedown.aSelect focusin.aSelect");
            ...
            openDropdown() {
                ...
                if (this.$scrollableParents) {
                    this.$scrollableParents.each(function () {
                        $__default["default"](this).on("scroll.aSelect", this.closeDropdown);
                    });
                }
                ...
                const self = this;
                $__default["default"](document).on("mousedown.aSelect focusin.aSelect", function (e) {
                    if (!($__default["default"](e.target).closest(`.a-select-wrapper[data-aselect-id="${self.options.id}"]`).length ||
                        $__default["default"](e.target).closest(`.a-select-dropdown[data-aselect-id="${self.options.id}"]`).length)) {
                        self.closeDropdown();
                    }
                });
            }
            ...
            upsertSelectOption(row) {
                ...
                if ($opt.length === 0) {
                    $opt = $__default["default"]("<option>").val(value).text(text).attr("data-a", "1");
            ...
            appendRowIfDoesNotExist(row, appendAtTop = false) {
                ...
                if (this.$tableBody.find(`[data-select-id="${value}"]`).length == 0) {
                    const $tr = $__default["default"]("<tr>").attr("data-select-id", value);
                    for (const key in row) {
            ...
            getUniqueValuesToExclude() {
                ...
                this.uniqueSelectors.forEach(selector => {
                    $__default["default"](selector).not(this.$select).each(function () {
                        const value = $__default["default"](this).val();
                        if (value) {
                ...
                if (this.isMultiple) {
                    ...
                    if (selectedOptions.length === 0) {
                        ...
                        const chips = selectedOptions.map((index, option) => {
                            const $option = $__default["default"](option);
                            return `
                    ...
                    `;
                        ...
                        this.$display.find('.a-select-chip-remove').on('click', (e) => {
                            e.stopPropagation();
                            const value = $__default["default"](e.currentTarget).data('value');
            ...
            cleanUp() {
                ...
                $__default["default"](document).off('.aSelect');
